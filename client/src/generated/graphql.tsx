...
export type ProductMutationResponseFragment = {
  ...
  product?: Maybe<{ __typename?: 'Product' } & ProductWithCategoryInfoFragment>
  errors?: Maybe<Array<{ __typename?: 'FieldError' } & FieldErrorFragment>>
} & ProductMutationStatusesFragment

export type ProductWithUserInfoFragment = { __typename?: 'Product' } & Pick<
  Product,
  | 'id'
  | 'title'
  | 'description'
...
export type ProductWithCategoryInfoFragment = { __typename?: 'Product' } & Pick<
  Product,
  'id' | 'title' | 'description' | 'price' | 'points' | 'likeType'
> & {
    user: { __typename?: 'User' } & Pick<User, 'username' | 'id'>
    category: { __typename?: 'Category' } & Pick<Category, 'title'>
  }
  ...
  categories?: Maybe<
    Array<
      { __typename?: 'Category' } & Pick<Category, 'id' | 'title'> & {
          products: Array<{ __typename?: 'Product' } & Pick<Product, 'title'>>
        }
    >
  >
}
...
export type ProductIdsQuery = { __typename?: 'Query' } & {
  products?: Maybe<
    { __typename?: 'PaginatedProducts' } & {
      paginatedProducts: Array<{ __typename?: 'Product' } & Pick<Product, 'id'>>
    }
  >
}
...
export type ProductsQuery = { __typename?: 'Query' } & {
  products?: Maybe<
    { __typename?: 'PaginatedProducts' } & Pick<
      PaginatedProducts,
      'totalCount' | 'cursor' | 'hasMore'
    > & {
        paginatedProducts: Array<
          { __typename?: 'Product' } & ProductWithCategoryInfoFragment
        >
      }
  >
}
 ...
 * });
 */
export function useProductIdsQuery(
  baseOptions: Apollo.QueryHookOptions<
    ProductIdsQuery,
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<ProductIdsQuery, ProductIdsQueryVariables>(
    ProductIdsDocument,
    options
  )
}
export function useProductIdsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    ProductIdsQuery,
    ProductIdsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<ProductIdsQuery, ProductIdsQueryVariables>(
    ProductIdsDocument,
    options
  )
}
export type ProductIdsQueryHookResult = ReturnType<typeof useProductIdsQuery>
export type ProductIdsLazyQueryHookResult = ReturnType<
  typeof useProductIdsLazyQuery
>
export type ProductIdsQueryResult = Apollo.QueryResult<
  ProductIdsQuery,
  ProductIdsQueryVariables
>
